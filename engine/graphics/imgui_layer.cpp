...
namespace VGED {
    namespace Engine {
        inline namespace Graphics {
            ...
            // using.
            ImguiLayer::ImguiLayer(Window &window, Device &_device, VkRenderPass renderPass, uint32_t imageCount) : device{ _device } {
                ...
                auto commandBuffer = device.begin_single_time_commands();
